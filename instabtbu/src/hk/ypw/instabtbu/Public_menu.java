...
public class Public_menu {
	...
	public void select(MenuItem item){
		try{
	    	...
	    	{
	    		try {
	    		Drawable drawable = thisActivity.getResources().getDrawable(R.drawable.fenxiang);
	    		FileOutputStream Os = thisActivity.openFileOutput("share.jpg", Context.MODE_WORLD_READABLE);
    ...
    /****************
    *
    * 发起添加群流程。群号：instabtbu用户交流群(99254687) 的 key 为： UU3oQFVAdguz3DtqKNAHjMsbYo9Hy__1
    * 调用 joinQQGroup(UU3oQFVAdguz3DtqKNAHjMsbYo9Hy__1) 即可发起手Q客户端申请加群 instabtbu用户交流群(99254687)
    *
    * @param key 由官网生成的key
