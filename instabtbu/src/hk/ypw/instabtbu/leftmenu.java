...
//		menu.setShadowDrawable(R.drawable.shadow_left);
		...
		ImageView jiaowuImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_jiaowu);
		ImageView shenghuoImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_shenghuo);
		ImageView shangwangImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_shangwang);
		ImageView ditieImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_ditie);
		ImageView xiaoyuankaImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_xiaoyuanka);
		ImageView aboutImageView = (ImageView) thisActivity.findViewById(R.id.leftmenu_about);
	...
	private void setalpha() {
		if(type==1)
		{
			thisActivity.findViewById(R.id.shangwang_deglu).getBackground().setAlpha(255);
			thisActivity.findViewById(R.id.shangwang_duankai).getBackground().setAlpha(255);
		}
	}
	...
	public void leftmenu_ui(int a)
	{
		...
		int[] tu1={R.drawable.left_shangwang1,
				R.drawable.left_jiaowu1,
				R.drawable.left_shenghuo1,
				R.drawable.left_xiaoyuanka1,
				R.drawable.left_ditie1,
				R.drawable.left_about1,
		};
		int[] tu0={R.drawable.left_shangwang0,
				R.drawable.left_jiaowu0,
				R.drawable.left_shenghuo0,
				R.drawable.left_xiaoyuanka0,
				R.drawable.left_ditie0,
				R.drawable.left_about0,
		};
		int i;
		for(i=0;i<myImageViews.length;i++)
		{
			if(i==a)myImageViews[i].setBackgroundResource(tu1[i]);
			else myImageViews[i].setBackgroundResource(tu0[i]);
		}
	}
}
