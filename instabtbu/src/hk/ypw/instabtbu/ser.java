...
public class ser extends Service {
	...
	public void onCreate() {
        ...
        Notification notification = new Notification(R.drawable.ser_logo,"instabtbu", System.currentTimeMillis());  
        ...
        MobclickAgent.updateOnlineConfig(this);
        notification.setLatestEventInfo(this, "instabtbu", MobclickAgent.getConfigParams(this,"t"),pendingIntent);
        //公告

        startForeground(1, notification);
        try{
	        PowerManager powerManager = (PowerManager)(this.getSystemService(Context.POWER_SERVICE));
	        if(wakeLock==null )wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "instabtbu_online"); 
	        wakeLock.acquire();
        }catch(Exception e)
        {
        	e.printStackTrace();
    	...
    	public void run(){
			...
			while(always)
			{
				if(always)
				{
					...
					shangwang.delaytime=SystemClock.currentThreadTimeMillis()-last;
				}
    ...
    final Handler handler = new Handler(){
  	  ...
  	  public void handleMessage(Message msg){
  		  try{
  			...
  			if(msg.what==1)
  			{
  				if(toast==null)toast=Toast.makeText(getApplicationContext(), toaststr, Toast.LENGTH_SHORT);
  				else toast.setText(toaststr);
  		    	toast.show();
  			}
  		  }catch(Exception e)
  		  {}
