		...
		public void bao8G(View v)
		{
			...
			builder.setPositiveButton("确认", new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					dialog2 = ProgressDialog.show(shangwang_liulianggoumai.this, "正在申请", "正在申请流量包……",true,true);
...
//		 			else 
	 				/**
	 				 * <td width="90%" height="388" class="STYLE11" align="center">您没有输入上网密码<br>
	 				 */
